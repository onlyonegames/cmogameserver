...
public interface MyVisitCompanionInfoRepository extends JpaRepository<MyVisitCompanionInfo, Long> {
    //@Transactional(propagation = Propagation.REQUIRES_NEW, readOnly = true)
    Optional<MyVisitCompanionInfo> findByUseridUser(Long userId);
}

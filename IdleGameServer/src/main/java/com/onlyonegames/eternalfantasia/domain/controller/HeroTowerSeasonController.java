...
@RestController
@AllArgsConstructor
public class HeroTowerSeasonController {
    private final MyHeroTowerSeasonService myHeroTowerSeasonService;

    @GetMapping("/api/GetSeasonInfo/HeroTower")
    public ResponseDTO<Map<String, Object>> GetSeasonInfo() {
        Map<String, Object> map = new HashMap<>();
        Long userId = (Long) SecurityContextHolder.getContext().getAuthentication().getPrincipal();
        Map<String, Object> response = myHeroTowerSeasonService.GetSeasonInfo(userId, map);

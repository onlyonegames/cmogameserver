...
//import com.onlyonegames.eternalfantasia.domain.service.Managementtool.HeroInfo.AnalysisTalentOption.TALENTOPTION_PERCENT_OR_FIXED_KIND;
//import com.onlyonegames.eternalfantasia.domain.service.Managementtool.HeroInfo.AnalysisTalentOption.TALENTOPTION_CONTINUITY_KIND;
//import com.onlyonegames.eternalfantasia.domain.service.Managementtool.HeroInfo.AnalysisTalentOption.TALENTOPTION_KIND;
//import com.onlyonegames.eternalfantasia.domain.service.Managementtool.HeroInfo.AnalysisTalentOption.TALENTOPTION_REQUIRE_KIND;

//import static com.onlyonegames.eternalfantasia.domain.service.Managementtool.HeroInfo.AnalysisTalentOption.TALENTOPTION_PERCENT_OR_FIXED_KIND;

public class EquipmentOptionInfoDto {
    public int id;
...
//    public AnalysisTalentOption.TALENTOPTION_REQUIRE_KIND TALENTOPTION_REQUIRE_KIND;
    public AnalysisTalentOption.TALENTOPTION_PERCENT_OR_FIXED_KIND PERCENT_OR_FIXEDVALUE;/*퍼센트 벨류인지 아닌지*/

    public void setEquipmentOptionInfo(EquipmentOptionsInfoTable equipmentOptionsInfoTable){
        this.id = equipmentOptionsInfoTable.getID();
        this.TALENTOPTION_HOWTO_PLUSE_KIND = getTALENTOPTION_PERCENT_OR_FIXED_KIND(equipmentOptionsInfoTable.getTALENTOPTION_HOWTO_PLUSE_KIND());
        this.TALENTOPTION_CONTINUITY_KIND = getTALENTOPTION_CONTINUITY_KIND(equipmentOptionsInfoTable.getCONTINUITY_KIND());
        this.TALENTOPTION_KIND = getTALENTOPTION_KIND(equipmentOptionsInfoTable.getKIND());
//        this.TALENTOPTION_REQUIRE_KIND = getTALENTOPTION_REQUIRE_KIND(equipmentOptionsInfoTable.getREQUIRE_KIND());
        this.PERCENT_OR_FIXEDVALUE = getTALENTOPTION_PERCENT_OR_FIXED_KIND(equipmentOptionsInfoTable.getTALENTOPTION_HOWTO_PLUSE_KIND());
    }
    ...
    AnalysisTalentOption.TALENTOPTION_KIND getTALENTOPTION_KIND(String k){
        switch(k){
            ...
            case "ENEMY_RECEIVE_CRITICAL_DMG_UP":

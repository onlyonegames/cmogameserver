...
@Transactional
@AllArgsConstructor
public class MyFieldDungeonPlayLogForBattleRecordService {
    ...
    public Map<String, Object> GetLog(Long userId, Map<String, Object> map) {
        ...
        for(MyFieldDungeonPlayLogForBattleRecord myFieldDungeonPlayLogForBattleRecord:myFieldDungeonPlayLogForBattleRecordList) {
            myFieldDungeonPlayLogForBattleRecord.CheckedLog();
        }
    ...
    public Map<String, Object> GetUserInfo(Long userId, Long matchUserId, Map<String, Object> map) {
        ...
        String userArenaTeamDeckIds = enemyTeamInfo.getFieldDungeonPlayTeam();
...
//        }
        ...
        String myTeamString = myTeamInfo.getFieldDungeonPlayTeam();

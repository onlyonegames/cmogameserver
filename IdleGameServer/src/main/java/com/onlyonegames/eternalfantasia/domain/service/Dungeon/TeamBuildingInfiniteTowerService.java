...
@Transactional
@AllArgsConstructor
public class TeamBuildingInfiniteTowerService {
...
//        String previousTeamInfo = myTeamInfo.getInfiniteTowerTeam();
        myTeamInfo.AddTeam(myCharacter.getId(), index, Defines.TEAM_BUILDING_KIND.INFINITE_TOWER_TEAM);
//        TeamBuildingLogDto teamBuildingLogDto = new TeamBuildingLogDto();
//        teamBuildingLogDto.setTeamBuildingLogDto("무한의 탑팀 추가", previousTeamInfo, myTeamInfo.getInfiniteTowerTeam());
...
//        loggingService.setLogging(useridUser, 6, log);
    ...
    public Map<String, Object> RemoveTeam(Long useridUser, int index, Long characterId, Map<String, Object> map) {
        ...
        MyTeamInfo myTeamInfo = myTeamInfoRepository.findByUseridUser(useridUser);
//        String previousTeamInfo = myTeamInfo.getInfiniteTowerTeam();
        myTeamInfo.RemoveTeam(index, Defines.TEAM_BUILDING_KIND.INFINITE_TOWER_TEAM);
//        TeamBuildingLogDto teamBuildingLogDto = new TeamBuildingLogDto();
//        teamBuildingLogDto.setTeamBuildingLogDto("무한의 탑팀 제거", previousTeamInfo, myTeamInfo.getInfiniteTowerTeam());
//        String log = JsonStringHerlper.WriteValueAsStringFromData(teamBuildingLogDto);
//        loggingService.setLogging(useridUser, 6, log);
        MyTeamInfoDto myTeamInfoDto = new MyTeamInfoDto();
        myTeamInfoDto.InitFromDBData(myTeamInfo);
    ...
    public Map<String, Object> SwitchTeam(Long useridUser, int indexA, Long characterIdA, int indexB, Long characterIdB, Map<String, Object> map) {
        ...
        MyTeamInfo myTeamInfo = myTeamInfoRepository.findByUseridUser(useridUser);
//        String previousTeamInfo = myTeamInfo.getInfiniteTowerTeam();
        myTeamInfo.SwitchTeam(indexA, indexB, Defines.TEAM_BUILDING_KIND.INFINITE_TOWER_TEAM);
//        TeamBuildingLogDto teamBuildingLogDto = new TeamBuildingLogDto();
//        teamBuildingLogDto.setTeamBuildingLogDto("무한의 탑팀 위치변경", previousTeamInfo, myTeamInfo.getInfiniteTowerTeam());
//        String log = JsonStringHerlper.WriteValueAsStringFromData(teamBuildingLogDto);
//        loggingService.setLogging(useridUser, 6, log);
        MyTeamInfoDto myTeamInfoDto = new MyTeamInfoDto();
        myTeamInfoDto.InitFromDBData(myTeamInfo);
    ...
    public Map<String, Object> TeamAutoSet(Long useridUser, String teamIds, Map<String, Object> map) {
        ...
        MyTeamInfo myTeamInfo = myTeamInfoRepository.findByUseridUser(useridUser);
//        String previousTeamInfo = myTeamInfo.getInfiniteTowerTeam();
        myTeamInfo.AutoTeamSet(teamIds, Defines.TEAM_BUILDING_KIND.INFINITE_TOWER_TEAM);
//        TeamBuildingLogDto teamBuildingLogDto = new TeamBuildingLogDto();
//        teamBuildingLogDto.setTeamBuildingLogDto("무한의 탑팀 자동편성", previousTeamInfo, myTeamInfo.getInfiniteTowerTeam());
//        String log = JsonStringHerlper.WriteValueAsStringFromData(teamBuildingLogDto);
//        loggingService.setLogging(useridUser, 6, log);
        MyTeamInfoDto myTeamInfoDto = new MyTeamInfoDto();
        myTeamInfoDto.InitFromDBData(myTeamInfo);

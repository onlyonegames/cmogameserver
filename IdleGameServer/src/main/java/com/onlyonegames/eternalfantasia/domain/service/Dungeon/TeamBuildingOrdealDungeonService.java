...
@Transactional
@AllArgsConstructor
public class TeamBuildingOrdealDungeonService {
...
//        String previousTeamInfo = myTeamInfo.getOrdealDungeonPlayTeam();
        myTeamInfo.AddTeam(myCharacter.getId(), index, Defines.TEAM_BUILDING_KIND.ORDEAL_DUNGEON_TEAM);
//        TeamBuildingLogDto teamBuildingLogDto = new TeamBuildingLogDto();
//        teamBuildingLogDto.setTeamBuildingLogDto("시련의 던전팀 추가", previousTeamInfo, myTeamInfo.getOrdealDungeonPlayTeam());
...
//        loggingService.setLogging(useridUser, 6, log);
    ...
    public Map<String, Object> RemoveTeam(Long useridUser, int index, Long characterId, Map<String, Object> map) {
        ...
        MyTeamInfo myTeamInfo = myTeamInfoRepository.findByUseridUser(useridUser);
//        String previousTeamInfo = myTeamInfo.getOrdealDungeonPlayTeam();
        myTeamInfo.RemoveTeam(index, Defines.TEAM_BUILDING_KIND.ORDEAL_DUNGEON_TEAM);
//        TeamBuildingLogDto teamBuildingLogDto = new TeamBuildingLogDto();
//        teamBuildingLogDto.setTeamBuildingLogDto("시련의 던전팀 제거", previousTeamInfo, myTeamInfo.getOrdealDungeonPlayTeam());
//        String log = JsonStringHerlper.WriteValueAsStringFromData(teamBuildingLogDto);
//        loggingService.setLogging(useridUser, 6, log);
        MyTeamInfoDto myTeamInfoDto = new MyTeamInfoDto();
        myTeamInfoDto.InitFromDBData(myTeamInfo);
    ...
    public Map<String, Object> SwitchTeam(Long useridUser, int indexA, Long characterIdA, int indexB, Long characterIdB, Map<String, Object> map) {
        ...
        MyTeamInfo myTeamInfo = myTeamInfoRepository.findByUseridUser(useridUser);
//        String previousTeamInfo = myTeamInfo.getOrdealDungeonPlayTeam();
        myTeamInfo.SwitchTeam(indexA, indexB, Defines.TEAM_BUILDING_KIND.ORDEAL_DUNGEON_TEAM);
//        TeamBuildingLogDto teamBuildingLogDto = new TeamBuildingLogDto();
//        teamBuildingLogDto.setTeamBuildingLogDto("시련의 던전팀 위치변경", previousTeamInfo, myTeamInfo.getOrdealDungeonPlayTeam());
//        String log = JsonStringHerlper.WriteValueAsStringFromData(teamBuildingLogDto);
//        loggingService.setLogging(useridUser, 6, log);
        MyTeamInfoDto myTeamInfoDto = new MyTeamInfoDto();
        myTeamInfoDto.InitFromDBData(myTeamInfo);
    ...
    public Map<String, Object> TeamAutoSet(Long useridUser,  String teamIds, Map<String, Object> map) {
        ...
        MyTeamInfo myTeamInfo = myTeamInfoRepository.findByUseridUser(useridUser);
//        String previousTeamInfo = myTeamInfo.getOrdealDungeonPlayTeam();
        myTeamInfo.AutoTeamSet(teamIds, Defines.TEAM_BUILDING_KIND.ORDEAL_DUNGEON_TEAM);
//        TeamBuildingLogDto teamBuildingLogDto = new TeamBuildingLogDto();
//        teamBuildingLogDto.setTeamBuildingLogDto("시련의 던전팀 자동편성", previousTeamInfo, myTeamInfo.getOrdealDungeonPlayTeam());
//        String log = JsonStringHerlper.WriteValueAsStringFromData(teamBuildingLogDto);
//        loggingService.setLogging(useridUser, 6, log);
        MyTeamInfoDto myTeamInfoDto = new MyTeamInfoDto();
        myTeamInfoDto.InitFromDBData(myTeamInfo);

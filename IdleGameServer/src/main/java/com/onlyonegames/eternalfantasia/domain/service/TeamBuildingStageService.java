...
@Service
@Transactional
public class TeamBuildingStageService {
    ...
    @Autowired
    public TeamBuildingStageService(MyTeamInfoRepository myTeamInfoRepository, MyCharactersRepository myCharactersRepository, ErrorLoggingService errorLoggingService, LoggingService loggingService) {
        this.myCharactersRepository = myCharactersRepository;
        this.myTeamInfoRepository = myTeamInfoRepository;
...
//        String previousTeamInfo = myTeamInfo.getStageTeam();
        myTeamInfo.AddTeam(myCharacter.getId(), index, Defines.TEAM_BUILDING_KIND.STAGE_PLAY_TEAM);
//        TeamBuildingLogDto teamBuildingLogDto = new TeamBuildingLogDto();
//        teamBuildingLogDto.setTeamBuildingLogDto("스테이지팀 추가", previousTeamInfo, myTeamInfo.getStageTeam());
...
//        loggingService.setLogging(useridUser, 6, log);
    ...
    public Map<String, Object> RemoveTeam(Long useridUser, int index, Long characterId, Map<String, Object> map) {
        ...
        MyTeamInfo myTeamInfo = myTeamInfoRepository.findByUseridUser(useridUser);
//        String previousTeamInfo = myTeamInfo.getStageTeam();
        myTeamInfo.RemoveTeam(index, Defines.TEAM_BUILDING_KIND.STAGE_PLAY_TEAM);
//        TeamBuildingLogDto teamBuildingLogDto = new TeamBuildingLogDto();
//        teamBuildingLogDto.setTeamBuildingLogDto("스테이지팀 제거", previousTeamInfo, myTeamInfo.getStageTeam());
//        String log = JsonStringHerlper.WriteValueAsStringFromData(teamBuildingLogDto);
//        loggingService.setLogging(useridUser, 6, log);
        MyTeamInfoDto myTeamInfoDto = new MyTeamInfoDto();
        myTeamInfoDto.InitFromDBData(myTeamInfo);
    ...
    public Map<String, Object> SwitchTeam(Long useridUser, int indexA, Long characterIdA, int indexB, Long characterIdB, Map<String, Object> map) {
        ...
        MyTeamInfo myTeamInfo = myTeamInfoRepository.findByUseridUser(useridUser);
//        String previousTeamInfo = myTeamInfo.getStageTeam();
        myTeamInfo.SwitchTeam(indexA, indexB, Defines.TEAM_BUILDING_KIND.STAGE_PLAY_TEAM);
//        TeamBuildingLogDto teamBuildingLogDto = new TeamBuildingLogDto();
//        teamBuildingLogDto.setTeamBuildingLogDto("스테이지팀 위치변경", previousTeamInfo, myTeamInfo.getStageTeam());
//        String log = JsonStringHerlper.WriteValueAsStringFromData(teamBuildingLogDto);
//        loggingService.setLogging(useridUser, 6, log);
        MyTeamInfoDto myTeamInfoDto = new MyTeamInfoDto();
        myTeamInfoDto.InitFromDBData(myTeamInfo);
    ...
    public Map<String, Object> TeamAutoSet(Long useridUser, String teamIds, Map<String, Object> map) {
        ...
        MyTeamInfo myTeamInfo = myTeamInfoRepository.findByUseridUser(useridUser);
//        String previousTeamInfo = myTeamInfo.getStageTeam();
        myTeamInfo.AutoTeamSet(teamIds, Defines.TEAM_BUILDING_KIND.STAGE_PLAY_TEAM);
//        TeamBuildingLogDto teamBuildingLogDto = new TeamBuildingLogDto();
//        teamBuildingLogDto.setTeamBuildingLogDto("스테이지팀 자동편성", previousTeamInfo, myTeamInfo.getStageTeam());
//        String log = JsonStringHerlper.WriteValueAsStringFromData(teamBuildingLogDto);
//        loggingService.setLogging(useridUser, 6, log);
        MyTeamInfoDto myTeamInfoDto = new MyTeamInfoDto();
        myTeamInfoDto.InitFromDBData(myTeamInfo);

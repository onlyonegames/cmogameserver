...
@Transactional
@AllArgsConstructor
public class TeamBuildingArenaService {
...
//        String previousTeamInfo = myTeamInfo.getArenaPlayTeam();
        myTeamInfo.AddTeam(myCharacter.getId(), index, Defines.TEAM_BUILDING_KIND.ARENA_TEAM);
//        TeamBuildingLogDto teamBuildingLogDto = new TeamBuildingLogDto();
//        teamBuildingLogDto.setTeamBuildingLogDto("아레나팀 추가", previousTeamInfo, myTeamInfo.getArenaPlayTeam());
//        String log = JsonStringHerlper.WriteValueAsStringFromData(teamBuildingLogDto);
//        loggingService.setLogging(useridUser, 6, log);
    ...
    public Map<String, Object> RemoveTeam(Long useridUser, int index, Long characterId, Map<String, Object> map) {
        ...
        MyTeamInfo myTeamInfo = myTeamInfoRepository.findByUseridUser(useridUser);
//        String previousTeamInfo = myTeamInfo.getArenaPlayTeam();
        myTeamInfo.RemoveTeam(index, Defines.TEAM_BUILDING_KIND.ARENA_TEAM);
//        TeamBuildingLogDto teamBuildingLogDto = new TeamBuildingLogDto();
//        teamBuildingLogDto.setTeamBuildingLogDto("아레나팀 제거", previousTeamInfo, myTeamInfo.getArenaPlayTeam());
//        String log = JsonStringHerlper.WriteValueAsStringFromData(teamBuildingLogDto);
//        loggingService.setLogging(useridUser, 6, log);
        MyTeamInfoDto myTeamInfoDto = new MyTeamInfoDto();
        myTeamInfoDto.InitFromDBData(myTeamInfo);
    ...
    public Map<String, Object> SwitchTeam(Long useridUser, int indexA, Long characterIdA, int indexB, Long characterIdB, Map<String, Object> map) {
        ...
        MyTeamInfo myTeamInfo = myTeamInfoRepository.findByUseridUser(useridUser);
//        String previousTeamInfo = myTeamInfo.getArenaPlayTeam();
        myTeamInfo.SwitchTeam(indexA, indexB, Defines.TEAM_BUILDING_KIND.ARENA_TEAM);
//        TeamBuildingLogDto teamBuildingLogDto = new TeamBuildingLogDto();
//        teamBuildingLogDto.setTeamBuildingLogDto("아레나팀 위치변경", previousTeamInfo, myTeamInfo.getArenaPlayTeam());
//        String log = JsonStringHerlper.WriteValueAsStringFromData(teamBuildingLogDto);
//        loggingService.setLogging(useridUser, 6, log);
        MyTeamInfoDto myTeamInfoDto = new MyTeamInfoDto();
        myTeamInfoDto.InitFromDBData(myTeamInfo);
    ...
    public Map<String, Object> TeamAutoSet(Long useridUser, String teamIds, Map<String, Object> map) {
        ...
        MyTeamInfo myTeamInfo = myTeamInfoRepository.findByUseridUser(useridUser);
//        String previousTeamInfo = myTeamInfo.getArenaPlayTeam();
        myTeamInfo.AutoTeamSet(teamIds, Defines.TEAM_BUILDING_KIND.ARENA_TEAM);
//        TeamBuildingLogDto teamBuildingLogDto = new TeamBuildingLogDto();
//        teamBuildingLogDto.setTeamBuildingLogDto("아레나팀 자동변성", previousTeamInfo, myTeamInfo.getArenaPlayTeam());
//        String log = JsonStringHerlper.WriteValueAsStringFromData(teamBuildingLogDto);
//        loggingService.setLogging(useridUser, 6, log);
        MyTeamInfoDto myTeamInfoDto = new MyTeamInfoDto();
        myTeamInfoDto.InitFromDBData(myTeamInfo);
    ...
    // 덱슬롯중 해당 인덱스를 해당 동료 나 영웅으로 설정
    public Map<String, Object> DefenceAddTeam(Long useridUser, int index, Long characterId, Map<String, Object> map) {
        ...
        MyTeamInfo myTeamInfo = myTeamInfoRepository.findByUseridUser(useridUser);
//        String previousTeamInfo = myTeamInfo.getArenaDefenceTeam();
        myTeamInfo.AddTeam(myCharacter.getId(), index, Defines.TEAM_BUILDING_KIND.ARENA_DEFEND_TEAM);
//        TeamBuildingLogDto teamBuildingLogDto = new TeamBuildingLogDto();
//        teamBuildingLogDto.setTeamBuildingLogDto("아레나 방어팀 추가", previousTeamInfo, myTeamInfo.getArenaDefenceTeam());
//        String log = JsonStringHerlper.WriteValueAsStringFromData(teamBuildingLogDto);
//        loggingService.setLogging(useridUser, 6, log);
        MyTeamInfoDto myTeamInfoDto = new MyTeamInfoDto();
        myTeamInfoDto.InitFromDBData(myTeamInfo);
    ...
    // 덱 내에 있는 영웅 및 동료중 해당 인덱스에 있는 것 빼주기
    public Map<String, Object> DefenceRemoveTeam(Long useridUser, int index, Long characterId, Map<String, Object> map) {
        ...
        MyTeamInfo myTeamInfo = myTeamInfoRepository.findByUseridUser(useridUser);
//        String previousTeamInfo = myTeamInfo.getArenaDefenceTeam();
        myTeamInfo.RemoveTeam(index, Defines.TEAM_BUILDING_KIND.ARENA_DEFEND_TEAM);
//        TeamBuildingLogDto teamBuildingLogDto = new TeamBuildingLogDto();
//        teamBuildingLogDto.setTeamBuildingLogDto("아레나 방어팀 제거", previousTeamInfo, myTeamInfo.getArenaDefenceTeam());
//        String log = JsonStringHerlper.WriteValueAsStringFromData(teamBuildingLogDto);
//        loggingService.setLogging(useridUser, 6, log);
        MyTeamInfoDto myTeamInfoDto = new MyTeamInfoDto();
        myTeamInfoDto.InitFromDBData(myTeamInfo);
    ...
    //덱 내에 있는 영웅들 끼리 인덱스 교체
    public Map<String, Object> DefenceSwitchTeam(Long useridUser, int indexA, Long characterIdA, int indexB, Long characterIdB, Map<String, Object> map) {
        ...
        MyTeamInfo myTeamInfo = myTeamInfoRepository.findByUseridUser(useridUser);
//        String previousTeamInfo = myTeamInfo.getArenaDefenceTeam();
        myTeamInfo.SwitchTeam(indexA, indexB, Defines.TEAM_BUILDING_KIND.ARENA_DEFEND_TEAM);
//        TeamBuildingLogDto teamBuildingLogDto = new TeamBuildingLogDto();
//        teamBuildingLogDto.setTeamBuildingLogDto("아레나 방어팀 위치변경", previousTeamInfo, myTeamInfo.getArenaDefenceTeam());
//        String log = JsonStringHerlper.WriteValueAsStringFromData(teamBuildingLogDto);
//        loggingService.setLogging(useridUser, 6, log);
        MyTeamInfoDto myTeamInfoDto = new MyTeamInfoDto();
        myTeamInfoDto.InitFromDBData(myTeamInfo);
    ...
    //덱 내에 있는 영웅들 중 전투력이 가장 높은 영웅 순으로 덱에 채워 넣는다.
    public Map<String, Object> DefenceTeamAutoSet(Long useridUser, String teamIds, Map<String, Object> map) {
        List<MyCharacters> myCharactersList = myCharactersRepository.findAllByuseridUser(useridUser);
        CheckTeamDeck(useridUser, teamIds, myCharactersList);
        MyTeamInfo myTeamInfo = myTeamInfoRepository.findByUseridUser(useridUser);
//        String previousTeamInfo = myTeamInfo.getArenaDefenceTeam();
        myTeamInfo.AutoTeamSet(teamIds, Defines.TEAM_BUILDING_KIND.ARENA_DEFEND_TEAM);
//        TeamBuildingLogDto teamBuildingLogDto = new TeamBuildingLogDto();
//        teamBuildingLogDto.setTeamBuildingLogDto("아레나 방어팀 자동편성", previousTeamInfo, myTeamInfo.getArenaDefenceTeam());
//        String log = JsonStringHerlper.WriteValueAsStringFromData(teamBuildingLogDto);
//        loggingService.setLogging(useridUser, 6, log);
        MyTeamInfoDto myTeamInfoDto = new MyTeamInfoDto();
        myTeamInfoDto.InitFromDBData(myTeamInfo);
    ...
    private void CheckTeamDeck(Long userId, String teamDeck, List<MyCharacters> myCharactersList){
        ...
        for(String temp:characterIdList){
            ...
            if(!duplicateCheck.add(characterId)){
                errorLoggingService.SetErrorLog(userId, ResponseErrorCode.LEGION_CANNOT_DUPLICATE.getIntegerValue(), "Legions Cannot Be Duplicate", this.getClass().getSimpleName(), Thread.currentThread().getStackTrace()[1].getMethodName(), IS_DIRECT_WRIGHDB);
                throw new MyCustomException("Fail -> Legions Cannot Be Duplicate", ResponseErrorCode.LEGION_CANNOT_DUPLICATE);
            }
        }
        if(heroCount == 0){

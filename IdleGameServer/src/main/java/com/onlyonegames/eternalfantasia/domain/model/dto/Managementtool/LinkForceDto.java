...
//    public AnalysisTalentOption.TALENTOPTION_REQUIRE_KIND TALENTOPTION_REQUIRE_KIND;
    ...
    public void setLinkForceOptionInfo(LinkforceTalentsTable linkforceTalentsTable){
        this.talentId = linkforceTalentsTable.getTalentID();
        String temp = linkforceTalentsTable.getTalentExplain().split("@")[1].replace("+","");
        if(temp.charAt(temp.length()-1) == '%')
            temp = temp.replace("%","");
        this.value = Float.parseFloat(temp);
        this.TALENTOPTION_HOWTO_PLUSE_KIND = getTALENTOPTION_PERCENT_OR_FIXED_KIND(linkforceTalentsTable.getTALENTOPTION_HOWTO_PLUSE_KIND());
        this.TALENTOPTION_CONTINUITY_KIND = getTALENTOPTION_CONTINUITY_KIND(linkforceTalentsTable.getCONTINUITY_KIND());
        this.TALENTOPTION_KIND = getTALENTOPTION_KIND(linkforceTalentsTable.getKIND());
//        this.TALENTOPTION_REQUIRE_KIND = getTALENTOPTION_REQUIRE_KIND(linkforceTalentsTable.getREQUIRE_KIND());
        this.PERCENT_OR_FIXEDVALUE = getTALENTOPTION_PERCENT_OR_FIXED_KIND(linkforceTalentsTable.getTALENTOPTION_HOWTO_PLUSE_KIND());
    }

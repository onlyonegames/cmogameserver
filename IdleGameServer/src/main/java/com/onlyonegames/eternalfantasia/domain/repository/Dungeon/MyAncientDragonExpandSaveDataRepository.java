...
public interface MyAncientDragonExpandSaveDataRepository extends JpaRepository<MyAncientDragonExpandSaveData, Long> {
    //@Transactional(propagation = Propagation.REQUIRES_NEW, readOnly = true)
    Optional<MyAncientDragonExpandSaveData> findByUseridUser(Long userId);
}

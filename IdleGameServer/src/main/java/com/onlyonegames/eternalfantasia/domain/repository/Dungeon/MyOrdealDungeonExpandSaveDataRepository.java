...
public interface MyOrdealDungeonExpandSaveDataRepository extends JpaRepository<MyOrdealDungeonExpandSaveData, Long> {
    //@Transactional(propagation = Propagation.REQUIRES_NEW, readOnly = true)
    Optional<MyOrdealDungeonExpandSaveData> findByUseridUser(Long userId);
}
